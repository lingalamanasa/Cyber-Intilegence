// ===== STACKLY CYBER INTELLIGENCE - Main JavaScript =====
...
function showAlert(message) {
  ...
  alert.style.cssText = 'position:fixed;top:20px;left:50%;transform:translateX(-50%);padding:14px 28px;background:linear-gradient(135deg,#00d4ff,#0099cc);color:#fff;border-radius:12px;z-index:9999;font-family:Outfit,sans-serif;font-size:0.95rem;display:flex;align-items:center;gap:10px;box-shadow:0 10px 30px rgba(0,212,255,0.3);animation:slideDown 0.3s ease';
...
function handleNewsletter(e) {
  e.preventDefault();
  showAlert('Subscribed successfully! Stay tuned for the latest cyber intelligence updates.');
  e.target.reset();
}
